...
from fit_to_md.infrastructure.fitdecode.builders import SplitBuilder as LegacySplitBuilder
from fit_to_md.infrastructure.fitdecode.builders import TransitionBuilder as LegacyTransitionBuilder
